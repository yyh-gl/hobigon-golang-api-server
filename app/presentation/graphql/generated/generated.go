...
func (ec *executionContext) unmarshalNNewBlog2githubᚗcomᚋyyhᚑglᚋhobigonᚑgolangᚑapiᚑserverᚋappᚋpresentationᚋgraphqlᚋmodelᚐNewBlog(ctx context.Context, v interface{}) (model.NewBlog, error) {
