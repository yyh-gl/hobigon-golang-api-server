...
func (ec *executionContext) field_Mutation_createBlog_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewBlog2githubᚗcomᚋyyhᚑglᚋhobigonᚑgolangᚑapiᚑserverᚋappᚋpresentationᚋgraphqlᚋmodelᚐNewBlog(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) fieldContext_Blog_count(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Blog",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) unmarshalInputNewBlog(ctx context.Context, obj interface{}) (model.NewBlog, error) {
	...
	for k, v := range asMap {
		...
		case "title":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("title"))
			it.Title, err = ec.unmarshalNID2string(ctx, v)
			if err != nil {
				return it, err
			}
		}
